<x-ai-pulse::layout>
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            <a href="{{ route('pulse.conversations.index') }}" class="quick-link-indigo">
            ...
            <a href="{{ route('pulse.playground.index') }}" class="quick-link-emerald">
            ...
            <a href="{{ route('pulse.usage.pricing') }}" class="quick-link-purple">
            ...
            <a href="{{ route('pulse.runs.index') }}" class="quick-link-cyan">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            <a href="{{ route('pulse.usage.index') }}"
            ...
            <a href="{{ route('pulse.usage.alerts') }}"
            ...
            <a href="{{ route('pulse.usage.health') }}"
