...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} — AI Pulse</title>

    <link rel="icon" type="image/svg+xml" href="{{ asset('vendor/ai-pulse/logo/favicon.svg') }}">

    <link rel="stylesheet" href="{{ asset('vendor/ai-pulse/css/pulse.css') }}">
        ...
        <div class="flex-1 flex flex-col min-w-0 relative z-10">
            ...
            <header class="glass-topbar h-[52px] flex items-center justify-between px-4 flex-shrink-0 mb-4">
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ config('ai-pulse.back_to_app_url', '/') }}"
            ...
            <main class="flex-1 pb-6 overflow-x-hidden">
                ...
                @php $healthIssues = \Syedmahroof\AiPulse\AiPulse::healthCheck(); @endphp
    ...
    <script>
        function toggleSidebar() {
            ...
            if (isCollapsed) {
                ...
                localStorage.setItem('pulse-sidebar-collapsed', 'false');
            } else {
                sidebar.classList.add('sidebar-collapsed');
                sidebar.style.width = '64px';
                collapseIcon.classList.add('hidden');
                expandIcon.classList.remove('hidden');
                localStorage.setItem('pulse-sidebar-collapsed', 'true');
            }
        }
        ...
        (function() {
            ...
            const collapsed = localStorage.getItem('pulse-sidebar-collapsed') === 'true';
            if (collapsed) {
                sidebar.classList.add('sidebar-collapsed');
                sidebar.style.width = '64px';
                collapseIcon.classList.add('hidden');
