...
>
    ...
    <div class="flex items-center gap-2.5 px-4 pt-4 pb-2">
        <div class="relative w-8 h-8 flex-shrink-0 logo-icon">
            <svg viewBox="0 0 64 64" class="w-8 h-8" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {{-- ECG / heartbeat pulse --}}
                <path d="M12 38 H24 L28 38 L32 16 L36 50 L40 38 H52"
                      stroke="url(#logoGrad)" stroke-width="3.2" stroke-linecap="round" stroke-linejoin="round"/>
                <circle cx="32" cy="16" r="2.6" fill="#2dd4bf"/>
                <defs>
        ...
        <span class="text-xl font-bold tracking-tight brand-text pulse-brand-title">
            <span class="text-gray-100 dark:text-gray-100">AI</span><span class="pulse-brand-gradient">Pulse</span>
        </span>
    </div>
    ...
    <div class="flex-1 overflow-hidden">
        <nav class="h-full overflow-y-auto py-2 px-2 space-y-0.5 nav-links">
            @php
                $links = [
                    ['route' => 'pulse.dashboard', 'label' => 'Dashboard', 'icon' => 'dashboard'],
                    ['route' => 'pulse.conversations.index', 'label' => 'Conversations', 'icon' => 'chat'],
                    ['route' => 'pulse.runs.index', 'label' => 'Runs', 'icon' => 'bolt'],
                    ['route' => 'pulse.playground.index', 'label' => 'Playground', 'icon' => 'play'],
                    ['route' => 'pulse.usage.index', 'label' => 'Usage', 'icon' => 'chart'],
                ];

                $advancedLinks = [
                    ['route' => 'pulse.prompt-lab.index', 'label' => 'Prompt Lab', 'icon' => 'prompt-lab'],
                    ['route' => 'pulse.usage.pricing', 'label' => 'Pricing', 'icon' => 'dollar'],
                    ['route' => 'pulse.usage.alerts', 'label' => 'Alerts', 'icon' => 'bell'],
                    ['route' => 'pulse.usage.health', 'label' => 'Health', 'icon' => 'heart'],
                    ['route' => 'pulse.audit.index', 'label' => 'Audit', 'icon' => 'shield'],
                    ['route' => 'pulse.prompts.index', 'label' => 'Prompts', 'icon' => 'bolt'],
                ];
            @endphp
...
<style>
    ...
    html:not(.dark) .pulse-brand-gradient {
    ...
    html:not(.dark) .pulse-brand-title span:first-child {
        color: #475569;
    }
