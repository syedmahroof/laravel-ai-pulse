<div class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" wire:model="name"
                            class="analyzer-input w-full" placeholder="e.g. Blog Writer, Code Reviewer">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="text" wire:model="tagInput" wire:keydown.enter="addTag"
                                ...
                                class="analyzer-input flex-1">
                            <button type="button" wire:click="addTag"
                                class="analyzer-btn-secondary text-xs">
                                Add
                            </button>
                        </div>
                        @if (!empty($tags))
    ...
    <div class="space-y-3">
        ...
        @empty
            <x-ai-analyzer::empty-state message="No prompts found. Create your first prompt above." />
        @endforelse
    </div>
