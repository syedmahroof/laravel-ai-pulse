    ...
    <x-ai-analyzer::card class="mb-4">
        ...
        <div class="mb-4">
            ...
            <div class="flex gap-2">
                ...
                <button type="button" wire:click="addRecipient" class="analyzer-btn-secondary">
                    Add
                </button>
            </div>
            ...
            <table class="analyzer-table w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/4">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors">
                        <td class="px-4 py-3 text-sm font-medium text-gray-900 dark:text-gray-50">{{ config('ai-analyzer.currency_symbol', '$') }}{{ number_format($alert->threshold_amount, 2) }}</td>
