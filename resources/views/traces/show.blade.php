<x-ai-pulse::layout>
    ...
    <div class="space-y-6">
        <div class="flex items-center gap-3">
            <a href="{{ route('pulse.conversations.index') }}" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('pulse.conversations.show', $conversation->id) }}"
        ...
        {{-- Timeline --}}
        @if ($messages->isEmpty())
            <x-ai-pulse::empty-state title="No messages" description="This conversation has no recorded messages to trace." />
        @else
            <div class="space-y-4">
