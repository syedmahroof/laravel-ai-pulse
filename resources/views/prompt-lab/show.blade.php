<x-ai-analyzer::layout>
    ...
    <div class="space-y-6">
        <div class="flex items-center gap-3">
            <a href="{{ route('analyzer.prompt-lab.index') }}" class="text-sm text-orbit-500 hover:text-orbit-600 dark:text-orbit-400 dark:hover:text-orbit-300 font-medium">&larr; Back to Prompt Lab</a>
        </div>
