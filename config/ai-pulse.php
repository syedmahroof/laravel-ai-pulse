...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | AI Pulse Dashboard Path
    |--------------------------------------------------------------------------
    |
    | The URI path where the AI Pulse dashboard will be accessible. Feel free to
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The authentication guard to use when checking access to the AI Pulse
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Middleware applied to all AI Pulse dashboard routes. The "web" middleware
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | AI Pulse Dashboard Domain
    |--------------------------------------------------------------------------
    |
    | Set a custom domain for the AI Pulse dashboard routes. Leave null to use
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This URL is used for the "Back to App" link in the AI Pulse dashboard
    | header. Set this to your application's home page or any URL where
    | users should return after using the AI Pulse dashboard.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Directories that AI Pulse will scan to discover agent classes. Paths are
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When enabled, AI Pulse listens to official Laravel AI SDK events for features
