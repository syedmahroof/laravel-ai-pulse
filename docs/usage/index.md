...
AI Analyzer's Usage & Analytics section gives you complete visibility into your AI spending, token consumption, and operational trends. Make data-driven decisions about model selection, agent optimization, and budget planning.

## Usage Dashboard

Access at `/ai-analyzer/usage`. This unified page combines today's stats with full analytics:
...
AI Analyzer safely checks for table and column existence:
...
- If `analyzer_ai_runs` doesn't exist, one-off run data is omitted
...
Then edit:
- `resources/views/vendor/ai-analyzer/usage/index.blade.php` — Usage dashboard
- `resources/views/vendor/ai-analyzer/usage/dashboard-livewire.blade.php` — Livewire CostDashboard component
