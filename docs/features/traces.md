...
Navigate to `/ai-analyzer/traces/{conversation_id}` or click **"View Trace"** from any conversation in the Thread Explorer or Message Timeline.
...
Then edit `resources/views/vendor/ai-analyzer/traces/show.blade.php`.
