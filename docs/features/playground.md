...
Access at `/ai-pulse/playground`. The playground lists all agents discovered by scanning your configured directories.

### Discovery

AI Pulse scans the directories configured in `config/ai-pulse.php`:
...
Access at `/ai-pulse/playground/{agent}`. The sandbox provides a fully functional chat interface for the selected agent.

![Agent Sandbox](/screenshots/sandbox.png)

### Intelligent Dependency Resolution

One of AI Pulse's most powerful features is automatic constructor dependency resolution. When you open a sandbox, AI Pulse analyzes the agent's constructor and classifies each parameter:
...
When an agent requires an Eloquent model, AI Pulse:
...
class InvoiceAgent implements Agent
{
    public function __construct(
        public Invoice $invoice,  // AI Pulse shows a picker with recent invoices
        public User $user,         // AI Pulse shows a picker with recent users
    ) {}
}
```
...
Then edit:
- `resources/views/vendor/ai-pulse/playground/index.blade.php` — Agent list
- `resources/views/vendor/ai-pulse/playground/show.blade.php` — Sandbox layout
- `resources/views/vendor/ai-pulse/livewire/agent-sandbox.blade.php` — Sandbox component
- `resources/views/vendor/ai-pulse/livewire/agent-inspector.blade.php` — Inspector panel
