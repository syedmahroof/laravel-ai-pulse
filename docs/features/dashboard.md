...
The AI Pulse Dashboard is your mission control for AI operations. It provides at-a-glance visibility into everything your agents are doing, updated in real time via Livewire.

![Dashboard Overview](/screenshots/dashboard.png)

## What You'll See

When you open `/ai-pulse`, the dashboard presents a comprehensive overview:
...
AI Pulse safely checks for table and column existence before querying, so the dashboard degrades gracefully if the SDK migrations haven't been run yet.
...
AI Pulse uses `JSON_EXTRACT` for efficient aggregation at the database level.
...
If you see a setup banner instead of stats, AI Pulse's health check has detected missing tables. Run:
...
Then edit `resources/views/vendor/ai-pulse/dashboard.blade.php`.

The Livewire component can also be extended — see [Extending AI Pulse](/customization/extending-orbit).
