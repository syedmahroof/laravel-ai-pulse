...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/syedmahroof/laravel-ai-pulse
...
AI Pulse auto-discovers your agents, reads from the SDK's existing tables, and presents everything in a polished standalone dashboard. No webpack, no Vite, no NPM — just Composer and go.

<p style="margin-top: 2rem;">
  <a href="/laravel-ai-pulse/getting-started/installation" class="orbit-cta-btn">Get Started →</a>
</p>
