...
All notable changes to Laravel AI Pulse are documented in this file.

## [1.0.0]

### Added
- **AI Run Observability** — AI Pulse-owned run journal for Laravel AI SDK events via official SDK event listeners
...
- **Merged Analytics** — TokenAggregator, CostCalculator, and Provider Health now merge data from both SDK conversations and `pulse_ai_runs`
- **Provider Health Data Source** — Always merges from `pulse_ai_runs` and `agent_conversation_messages` instead of either-or gating
...
### Added
- Initial release of Laravel AI Pulse
