...
namespace Syedmahroof\AiAnalyzer\Services\Concerns;
...
trait UsesAiConnection
{
    ...
    private function logMissingTable(string $table): void
    {
        ...
        Log::warning("Laravel AI Analyzer: table [{$table}] not found. Run [php artisan migrate] to create the Laravel AI SDK tables.");
    }
}
