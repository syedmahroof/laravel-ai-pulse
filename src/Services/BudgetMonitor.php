...
class BudgetMonitor
{
    ...
    {
        if (! config('ai-analyzer.budget.enabled', true)) {
            return;
        }
    ...
    public function checkCompletedEvent(object $event): void
    {
        ...
        $shouldAddEventCost = ! config('ai-analyzer.observability.store_runs', true)
            || ! Schema::hasTable('analyzer_ai_runs');
    ...
    {
        return Schema::hasTable('analyzer_ai_runs')
